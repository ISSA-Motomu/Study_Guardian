...
import { playSound } from './modules/utils.js?v=6';
import { gameModule } from './modules/game.js?v=6';
import { studyModule } from './modules/study.js?v=6';
import { chartsModule } from './modules/charts.js?v=6';
